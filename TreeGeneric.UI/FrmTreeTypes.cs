...
namespace TreeGeneric.UI
{
    public partial class FrmTreeTypes : Form
    {
        ...
        private void btnAddTreeType_Click(object sender, EventArgs e)
        {
        ...
        private void btnEditTreeType_Click(object sender, EventArgs e)
        {
        ...
        private void btnDeleteTreeType_Click(object sender, EventArgs e)
        {
            if (dataGridView1.CurrentRow != null)
            {
                int id = int.Parse(dataGridView1.CurrentRow.Cells[0].Value.ToString());
